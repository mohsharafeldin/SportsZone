...
class LeaguesDetailsCollectionViewController: UICollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0:
            ...
            //for test
            cell.config(event: EventModel(eventName: "Pimera", team1: TeamModel(name: "Villarreal"), team2: TeamModel(name: "Madrid"), score: "VS", time: "21:00 | Round 38"))
        ...
        case 2:
            ...
            //for test
            cell.config(event: EventModel(eventName: "Pimera", team1: TeamModel(name: "Villarreal"), team2: TeamModel(name: "Madrid"), score: "1 - 0", time: "21:00 | Round 38"))
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        let header = collectionView.dequeueReusableSupplementaryView(ofKind: kind, withReuseIdentifier: "HeaderViewItem", for: indexPath) as! HeaderView
